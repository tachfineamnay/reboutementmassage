export const COPY = {
  EN: {
    ...
    contact: {
      ...
      headline: "For hotels, villas, conciergeries and yachts.",
      sub: "Share the context. We will confirm the most appropriate format and availability.",
      fields: {
      ...
      sent: "Received. We will reply discreetly.",
  ...
  FR: {
    ...
    contact: {
      ...
      headline: "Pour hôtels, villas, conciergeries et yachts.",
      sub: "Partagez le contexte. Nous confirmons le format le plus adapté et les disponibilités.",
      fields: {
      ...
      submit: "Demander une disponibilité",
      sent: "Bien reçu. Réponse discrète à suivre.",
  ...
  ES: {
    ...
    contact: {
      ...
      headline: "Para hoteles, villas, conserjerías y yates.",
      sub: "Comparta el contexto. Confirmaremos el formato más adecuado y la disponibilidad.",
      fields: {
      ...
      sent: "Recibido. Responderemos con discreción.",
