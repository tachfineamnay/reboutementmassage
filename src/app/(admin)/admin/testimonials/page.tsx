...
export const metadata: Metadata = { title: "Témoignages — Growth CMS", robots: { index: false, follow: false } };
...
export default async function TestimonialsPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="admin-page">
      <AdminPageHeader title="Témoignages" meta={`${total} témoignage${total !== 1 ? "s" : ""}`} action={{ href: "/admin/testimonials/new", label: "+ Nouveau témoignage" }} />
